...
function startMessaging(){
    ...
    const messages = [
        ...
        {
            message: "Sometimes life goes tough.. emotions go crazy.. but at the end everything becomes fine...",
            waitTime: 18000,
        },
        {
